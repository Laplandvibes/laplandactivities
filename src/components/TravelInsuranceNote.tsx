...
export default function TravelInsuranceNote({
  ...
  const eyebrow = pick(lang,
    ...
    'Prima di prenotare le attività', 'Voordat je activiteiten boekt', 'Innan du bokar aktiviteter')
  ...
  const h2 = pick(lang,
    ...
    '旅行保険が実際に何をカバーするか確認を',
    'Comprueba qué cubre realmente tu seguro de viaje',
  ...
  const cards = [
    ...
    },
    {
      ...
      b: pick(lang,
        ...
        'Su nivel intermedio, "Active rest", es el que en su lista menciona "viajar como conductor o pasajero en quads… y motos de nieve", y en su texto comercial "snowboard y esquí alpino en pistas señalizadas". Fuera de pista es un nivel más. Sea cual sea tu aseguradora, esa es la línea que hay que leer antes de pagar.',
        ...
        'Hun middenniveau "Active rest" is degene wiens lijst "reizen als bestuurder of passagier op quads… en sneeuwscooters" noemt, en in de marketingtekst "snowboarden, afdalingsskiën op gemarkeerde pistes". Buiten de piste is weer een niveau hoger. Bij welke verzekeraar dan ook: dit is de regel die je leest vóór je betaalt.',
    ...
    },
    {
      ...
      b: pick(lang,
        ...
        'Una empresa de safaris asegura su propia responsabilidad, no tu factura médica. Si te rompes una muñeca en una moto de nieve, el tratamiento y la vuelta a casa los pagas tú o tu aseguradora. Ese hueco se cierra antes de salir, no en el aeropuerto.',
  ...
  const ctaLead = pick(lang,
    ...
    'Si tu póliza actual se queda en "cargas ligeras", EKTA es una aseguradora que vende los niveles de actividad por separado y cubre a viajeros de casi cualquier país. Compárala con lo que ya tienes antes de pagar dos veces.',
    ...
    <section id="insurance" className={className} aria-label={h2}>
      ...
      <div className="mt-6 rounded-2xl bg-white/5 ring-1 ring-white/10 p-6 text-center">
        ...
        <p className="mt-4 text-xs text-snow/60 max-w-2xl mx-auto">{pick(lang,
          ...
          'Este es un enlace de afiliado: si compras a través de él podemos ganar una comisión, sin coste extra para ti.',
