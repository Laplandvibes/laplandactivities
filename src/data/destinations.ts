...
export const destinations: Destination[] = [
  ...
  },
  {
    ...
    why: 'Tornio and Haparanda are one town in two countries: you can walk across the border in the middle of the shopping street, spend a day comparing prices and ranges on both sides with IKEA Haparanda right by the crossing, and play a golf round that switches country and time zone four times. Kemi, 25 minutes away, adds the Icebreaker Sampo cruise and the SnowCastle Area\'s winter snow park. Down the Tornionjoki, Europe\'s largest free-flowing salmon river, the Kukkolankoski rapids still run traditional dipnet fishing each summer.',
