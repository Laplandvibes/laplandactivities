...
const guides: Guides = {
  destinations: {
    rovaniemi: {
      ...
      planStay: 'Zwei bis drei Nächte reichen für das Weihnachtsmanndorf, eine große Safari und einen Nordlichtabend ohne Hetze. Buchen Sie Husky- und Schneemobiltouren für Dezember und die Hochsaison im Februar und März früh. Die Polarkreislinie zu überqueren kostet nichts, die Urkunde dagegen schon: Sie ist ein Souvenir für wenige Euro und liegt in der Touristeninformation am Polarkreis, im Polarkreisturm oder im Laden des Weihnachtshauses aus, nicht im Postamt. Der Ounasvaara liegt nah genug für eine Abfahrt am Abend.',
    },
    levi: {
    ...
    tornio: {
      ...
      planGetting: 'Vom Flughafen Kemi sind es etwa zehn Minuten nach Kemi selbst, und Tornio liegt rund fünfundzwanzig Minuten entfernt, beide Städte lassen sich also als eine Reise behandeln. Tornio und Haparanda sind eine Stadt in zwei Ländern: Die Grenze verläuft mitten durch die Einkaufsstraße und wird zu Fuß überquert.',
