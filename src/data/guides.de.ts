...
const guides: Guides = {
  destinations: {
    ...
    levi: {
      ...
      seasonSummer: 'Im Sommer bringt die Gondel statt Skifahrern den Levi Bike Park nach oben, und der Fjell wird zum Wandergebiet. Golf unter der Mitternachtssonne ist die örtliche Kuriosität: Abschlag kurz vor Mitternacht, Runde bei vollem Tageslicht. Die 230 Loipenkilometer des Winters dienen schneefrei als Wander- und Laufwege.',
    ...
    yllas: {
      ...
      seasonWinter: 'Zwei Dörfer teilen sich einen Fjell und zusammen 62 Pisten, darunter Abfahrten von über drei Kilometern, die längsten Finnlands. Ringsum liegen etwa 300 Kilometer gespurte Loipen, die bis in den Nationalpark Pallas-Yllästunturi reichen. Der Himmel ist hier dunkel und offen, weshalb Nordlichttouren vom Fjell selbst starten und nicht aus einem beleuchteten Dorf.',
      seasonSummer: 'Sobald die Loipe schmilzt, wird derselbe Nationalpark zum Wandergebiet: markierte Routen über offenes Fjell, durch alten Fichtenwald und auf Bohlenwegen durchs Moor. Der Spätsommer gehört Beeren und Pilzen, im Herbst färbt die Ruska die Hänge vor dem ersten Schnee. Der Sommer am Ylläs ist still, wie es die Skiwochen nie sind.',
      planTitle: 'Eine Reise nach Ylläs planen',
      planGetting: 'Vom Flughafen Kittilä fährt man etwa 35 Minuten. Die beiden Dörfer liegen auf gegenüberliegenden Seiten des Fjells und die Straße dazwischen ist lang: Entscheiden Sie vor der Buchung, welche Seite es sein soll. Äkäslompolo ist die ruhigere, in Ylläsjärvi sind die Bars. Ein Auto erleichtert den Wechsel erheblich.',
    ...
    'pyha-luosto': {
      ...
      seasonWinter: 'Zwei Fjelldörfer liegen an den Enden einer alten Fjellkette, dazwischen der Nationalpark. Pyhä hat das steilere Skifahren, darunter Huttu-Ukko, eine Buckelpiste mit Weltcupvergangenheit, dazu sanftes Gelände und kurze Liftschlangen für Familien. In Luosto zieht ein beheizter Schneezug die Besucher durch die dunklen Monate zur Amethystmine auf dem Lampivaara.',
      seasonSummer: 'Schneefrei ist der Park ein Wanderziel: Bohlenwege durch alten Wald und Isokuru, mit rund 220 Metern die tiefste Schlucht Finnlands, dazu freie Sicht über die älteste Fjellkette Lapplands. Die Amethystmine bleibt geöffnet und ist die einzige aktive Mine Europas, in der Besucher graben und einen Stein behalten dürfen.',
  ...
  categories: {
    ...
    food: {
      ...
      covers: 'Essen ist hier an Feuer und Jahreszeit gebunden. Eine Kota oder Kammi ist eine kegelförmige Hütte mit offener Feuerstelle in der Mitte, und das Essen entsteht vor Ihren Augen: Rentier, Fisch, Fladenbrot, Moltebeeren. Abseits des Tisches gibt es das Sammeln von Wildbeeren und Pilzen, und in Kukkolankoski wird der Maräne noch mit dem traditionellen Kescher gefangen.',
      whenToGo: 'Lagerfeueressen laufen ganzjährig und sind in der dunklen Jahreshälfte am stärksten, wenn das Feuer das einzige Licht im Raum ist. Sammeln ist eine Sache des Spätsommers und Herbstes: Beeren ab Juli, Pilze ab August. Die Maränensaison in Kukkolankoski gehört dem Sommer und folgt dem Aufstieg im Fluss.',
