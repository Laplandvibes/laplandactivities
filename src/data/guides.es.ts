...
const guides: Guides = {
  destinations: {
    rovaniemi: {
      ...
      planStay: 'Dos o tres noches bastan para la Aldea de Papá Noel, un safari grande y una noche de auroras sin agobios. Reserve con antelación las salidas de huskies y motonieve de diciembre y del pico de febrero y marzo. El certificado de cruce del Círculo Polar, en la oficina de correos de la Aldea, no cuesta nada, y Ounasvaara queda lo bastante cerca para esquiar por la tarde.',
    },
    levi: {
    ...
    tornio: {
      ...
      planGetting: 'El aeropuerto de Kemi está a un cuarto de hora de Tornio, y Kemi a unos veinticinco minutos, así que las dos ciudades funcionan como un solo viaje. Tornio y Haparanda son una ciudad en dos países: la frontera pasa por el medio de la calle comercial y se cruza a pie.',
