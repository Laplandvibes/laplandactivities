...
const guides: Guides = {
  destinations: {
    rovaniemi: {
      ...
      seasonWinter: 'De noviembre a marzo el río se congela, la nieve se asienta y casi toda la oferta abre a la vez: safaris en motonieve, trineos de huskies y de renos, pesca en hielo y salidas a cazar auroras. En pleno invierno el sol apenas asoma sobre el horizonte, y precisamente por eso las auroras se ven tan bien aquí. Navidad y Año Nuevo son las dos semanas más concurridas del año en la ciudad.',
      seasonSummer: 'De junio a agosto la nieve deja paso a una luz que en realidad nunca termina. Las granjas de huskies siguen abiertas para visitas de verano y encuentros con cachorros, el Arktikum y el SantaPark funcionan todo el año, y la orilla del Kemijoki se convierte en el centro de la ciudad. Septiembre y octubre traen los colores del ruska a Ounasvaara y las primeras auroras de la temporada, con mucha menos gente en los senderos.',
  ...
  categories: {
    ...
    culture: {
      ...
      covers: 'Por esta categoría corren dos hilos. Uno es la cultura sami, que se conoce mejor en Siida, en Inari, museo sami y centro de naturaleza en la sede del Parlamento Sami de Finlandia, y en Samiland, en Levi. El otro es el relato ártico que la región cuenta sobre sí misma: la Pueblo de Papá Noel y el SantaPark en Rovaniemi, el Arktikum junto al río y los recintos construidos en hielo.',
      ...
      choosing: 'Si quiere cultura viva y no una función, empiece por Siida y por una visita a pastores de renos en activo en Inari, no por un espectáculo. Si viaja con niños, la Pueblo de Papá Noel y el SantaPark están hechos justamente para ellos. El Arktikum tiene la exposición sobre auroras más sólida del país y aguanta media jornada bajo techo.',
