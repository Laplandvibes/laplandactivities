...
const guides: Guides = {
  destinations: {
    ...
    tornio: {
      ...
      planGetting: 'Kemin lentoasemalta on Kemiin itseensä noin kymmenen minuuttia, ja Tornioon noin kaksikymmentäviisi, joten kaupungit toimivat yhtenä matkana. Tornio ja Haaparanta ovat yksi kaupunki kahdessa maassa: raja kulkee keskellä kauppakatua ja sen ylittää jalan.',
