...
const guides: Guides = {
  destinations: {
    rovaniemi: {
      ...
      seasonWinter: 'De novembre à mars, le fleuve gèle, la neige tient et presque tout le catalogue ouvre en même temps : safaris en motoneige, traîneaux à chiens et à rennes, pêche sur glace et chasses aux aurores. Au cœur de l\'hiver, le soleil dépasse à peine l\'horizon, et c\'est précisément pour cela que les aurores se voient si bien ici. Noël et le Nouvel An sont les deux semaines les plus chargées de l\'année.',
      ...
      planStay: 'Deux ou trois nuits suffisent pour le village du père Noël, un grand safari et une soirée aurores sans courir. Réservez tôt les départs traîneau et motoneige de décembre et du pic de février-mars. Le certificat de passage du cercle polaire, à la poste du village du père Noël, ne coûte rien, et l\'Ounasvaara est assez proche pour une session de ski en soirée.',
    },
    levi: {
    ...
    inari: {
      ...
      seasonSummer: 'À partir de juin, le lac rouvre : les bateaux passent devant Ukonsaari, l\'île sacrée, et le kayak sous le soleil de minuit étire une soirée ordinaire sur toute la nuit. On rejoint à pied l\'église de nature sauvage de Pielpajärvi à travers une vieille pinède, et fin juillet les mûres arctiques mûrissent dans les tourbières le long du sentier.',
    ...
    kemijarvi: {
      ...
      seasonWinter: 'La ville est posée sur son propre lac, qui gèle en terrain de pêche sur glace à distance de marche du centre. La fjeld de ski Suomu est à une quarantaine de minutes, les prestataires de traîneaux proposent des safaris que vous conduisez vous-même plutôt que des places de passager, et sur la rive d\'Uitonniemi le petit village du père Noël associe un hôtel en rondins, des rencontres avec le père Noël et des sorties aurores.',
  ...
  categories: {
    ...
    'winter-sports': {
      ...
      bring: 'La location existe dans chaque station et se règle plus facilement sur place que les excursions. Prenez masque et cache-cou : le vent sur une fjeld ouverte fait plus de dégâts que ne le suggère le thermomètre. Les fondeurs consulteront le bulletin des pistes avant de choisir un versant, car le damage varie d\'un village à l\'autre.',
    },
    wellness: {
    ...
    culture: {
      ...
      bring: 'Les musées ne demandent que du temps, et Siida mérite au moins trois heures. Dans les hôtels de glace et les villages de neige, il gèle aussi à l\'intérieur : gardez vos couches d\'extérieur pendant la visite. À Tankavaara, tout ce que vous lavez vous appartient, et au Lampivaara vous pouvez creuser et garder une améthyste.',
    },
    summer: {
      ...
      whenToGo: 'Juin à août forme le cœur de la saison, et au solstice le soleil reste au-dessus de l\'horizon jour et nuit à cette latitude. Fin juillet arrivent les mûres arctiques et les premiers champignons. Septembre et octobre sont les semaines du ruska, quand les fjelds changent de couleur et que les premières aurores reviennent, avec des sentiers presque vides.',
