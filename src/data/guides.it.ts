...
const guides: Guides = {
  destinations: {
    rovaniemi: {
      ...
      planStay: 'Due o tre notti bastano per il Villaggio di Babbo Natale, un safari importante e una serata di aurore senza correre. Prenoti con anticipo le partenze in slitta e in motoslitta di dicembre e del picco di febbraio e marzo. Attraversare la linea del Circolo Polare non costa nulla, mentre il certificato è un souvenir a pagamento di pochi euro: si compra all\'ufficio turistico del Circolo Polare, alla torre del Circolo Polare o al negozio della Casa del Natale, non all\'ufficio postale. L\'Ounasvaara è abbastanza vicino per una sciata serale.',
    },
    levi: {
    ...
    posio: {
      ...
      planStay: 'Prenda Posio come la giornata tranquilla dentro un viaggio più ampio in Lapponia: un parco nazionale, un canyon e la fabbrica di ceramica la riempiono comodamente. I fotografi vengano tra gennaio e marzo per gli alberi carichi di neve. I sentieri sono segnati ma i servizi sono radi, quindi porti cibo e acqua.',
    },
    tornio: {
      seasonsTitle: 'Tornio, Haparanda e Kemi stagione per stagione',
      seasonWinter: 'Qui l\'inverno costruisce invece di limitarsi a coprire. Il parco di neve dell\'area SnowCastle di Kemi viene rifatto da zero ogni inverno, e il rompighiaccio Sampo esce nel golfo di Botnia ghiacciato e lascia i passeggeri galleggiare in tuta di sopravvivenza fra le lastre. Nessuno dei due esiste d\'estate, il che fa di questa la sola destinazione della Lapponia le cui attrazioni principali siano rigorosamente stagionali.',
      ...
      planGetting: 'L\'aeroporto di Kemi dista una decina di minuti da Kemi stessa, e Tornio circa venticinque minuti, quindi le due città funzionano come un viaggio solo. Tornio e Haparanda sono una città in due Paesi: il confine passa in mezzo alla via dello shopping e si attraversa a piedi.',
      planStay: 'È la destinazione della Lapponia più facile da unire a una giornata di acquisti, con IKEA Haparanda proprio accanto al valico e prezzi che vale la pena confrontare su entrambi i lati. Una o due notti bastano d\'inverno per il rompighiaccio e lo SnowCastle, d\'estate per il fiume e il campo da golf.',
    },
    'pyha-luosto': {
