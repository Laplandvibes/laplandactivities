...
const guides: Guides = {
  destinations: {
    ...
    yllas: {
      ...
      seasonWinter: 'Duas vilas dividem um fjeld e 62 pistas no total, com descidas de mais de três quilômetros, as mais longas da Finlândia. Ao redor se estendem cerca de 300 quilômetros de pista de cross-country preparada que chegam ao parque nacional Pallas-Yllästunturi. O céu aqui é escuro e aberto, e por isso as saídas de aurora partem do próprio fjeld em vez de uma vila iluminada.',
      seasonSummer: 'Quando a pista derrete, o mesmo parque nacional vira terreno de caminhada: rotas sinalizadas pelo fjeld aberto, floresta velha de abetos e passarelas de madeira sobre a turfeira. O fim do verão é época de frutas silvestres e cogumelos, e no outono o ruska tinge as encostas antes da primeira neve. O verão em Ylläs é silencioso de um jeito que as semanas de esqui nunca são.',
      planTitle: 'Planejando uma viagem a Ylläs',
      planGetting: 'O aeroporto de Kittilä fica a uns 35 minutos de carro. As duas vilas ficam em lados opostos do fjeld e a estrada entre elas é longa, então decida o lado antes de reservar: Äkäslompolo é a mais calma, em Ylläsjärvi estão os bares. Um carro facilita muito o vaivém.',
    ...
    posio: {
      ...
      seasonSummer: 'Sem neve, o mesmo cânion vira uma trilha por um vale de falha íngreme e arborizado, e o Riisitunturi se abre como uma caminhada de fjeld mais fácil, com vistas longas sobre os lagos. A Pentik, fábrica de cerâmica mais ao norte do mundo, mantém galerias e loja de fábrica abertas o ano inteiro e preenche as horas quando o tempo vira.',
    ...
    tornio: {
      ...
      seasonWinter: 'Aqui o inverno constrói em vez de apenas cobrir. O SnowCastle de Kemi é erguido do zero todo inverno, e o quebra-gelo Sampo sai pelo golfe de Bótnia congelado e deixa os passageiros boiarem de macacão de sobrevivência entre as placas de gelo. Nenhum dos dois existe no verão, o que faz deste o único destino da Lapônia cujas atrações principais são estritamente sazonais.',
    ...
    'pyha-luosto': {
      ...
      seasonWinter: 'Duas vilas de fjeld ocupam as pontas de uma cadeia antiga, com o parque nacional no meio. Pyhä tem o esqui mais íngreme, incluindo a Huttu-Ukko, pista de bumps com passado de Copa do Mundo, além de terreno suave e filas curtas para famílias. Em Luosto, um trem da neve aquecido leva os visitantes ao Lampivaara e à mina de ametista durante os meses escuros.',
      seasonSummer: 'Sem neve, o parque é destino de caminhada: passarelas pela floresta antiga e o Isokuru, a garganta mais profunda da Finlândia com cerca de 220 metros, além de vistas abertas ao longo da cadeia de fjelds mais antiga da Lapônia. A mina de ametista segue aberta e é a única mina ativa da Europa onde o visitante pode cavar e ficar com uma pedra.',
    ...
    kemijarvi: {
      ...
      seasonWinter: 'A cidade fica sobre o próprio lago, que congela e vira área de pesca no gelo a poucos passos do centro. O fjeld de esqui Suomu fica a uns quarenta minutos, as operadoras de husky oferecem safáris que você mesmo conduz em vez de passeios como passageiro, e na margem de Uitonniemi a pequena vila do Papai Noel junta um pequeno hotel de troncos a encontros com o Papai Noel e saídas de aurora.',
  ...
  categories: {
    ...
    'winter-sports': {
      ...
      bring: 'Há aluguel em todas as estações e ele se resolve mais fácil na chegada do que os passeios. Leve óculos de proteção e algo para cobrir o rosto: o vento no fjeld aberto faz mais estrago do que o termômetro sugere. Quem for de cross-country deve checar o boletim das pistas antes de escolher um lado do fjeld, porque a preparação varia entre as vilas.',
    },
    wellness: {
    ...
    culture: {
      coversTitle: 'Herança sami, Papai Noel e a narrativa ártica',
      covers: 'Dois fios atravessam esta categoria. Um é a cultura sami, mais bem conhecida no Siida, em Inari, museu sami e centro de natureza na sede do Parlamento Sami da Finlândia, e no Samiland, em Levi. O outro é a narrativa ártica que a região conta sobre si mesma: a Vila do Papai Noel e o SantaPark em Rovaniemi, o Arktikum à beira do rio e os espaços construídos em gelo.',
    ...
    summer: {
      ...
      whenToGo: 'Junho a agosto é o núcleo, e no solstício o sol fica acima do horizonte 24 horas nesta latitude. No fim de julho chegam as amoras-árticas e os primeiros cogumelos. Setembro e outubro são as semanas do ruska, quando os fjelds mudam de cor e as primeiras auroras voltam, com as trilhas quase vazias.',
  ...
  indexes: {
    destList: {
      ...
      lead: 'A Lapônia não é um lugar só com uma estação só. Rovaniemi tem o aeroporto, o trem noturno e a maior variedade de passeios. Levi e Ruka são vilas de esqui que se atravessam a pé. Ylläs e Saariselkä trocam vida noturna por céu escuro e o silêncio do parque nacional. Em Inari a cultura sami é encontrada em vez de encenada, e Posio, Tornio e Kemijärvi são os destinos calmos.',
