...
const KEYWORD_IMAGE: Array<{ match: RegExp; img?: string; imgs?: string[] }> = [
  ...
  { match: /snowmobile|kelkka|skidoo/i,
        imgs: [local('activities/winter/snowmobile-river.webp'), local('heroes/winter-band-snowmobile-trail.webp')] },
  { match: /ice ?kart|go.?kart|karting/i,                              img: local('activities/winter/snowmobile-river.webp') },
  { match: /arctic snow ?hotel/i,                                       img: local('heroes/winter-band-snowmobile-trail.webp') },
...
const CATEGORY_HERO: Record<string, string> = {
  ...
  adventure:        seasonal(local('activities/adventure/korouoma-frozen.webp'), local('activities/summer/kayak.webp')),
