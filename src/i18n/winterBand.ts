...
export const WINTER_BAND: Record<Lang, WinterBandCopy> = {
  ...
  fr: {
    ...
    highlights: [
      ...
      { title: 'Safaris en motoneige', body: 'Lacs gelés et pistes de fjäll, du tranquille à la sortie journée.' },
      { title: 'Chasse aux aurores', body: 'Sorties au ciel sombre avec des guides qui lisent la météo pour vous.' },
      { title: 'Pêche blanche & sauna', body: 'Percez la glace, puis réchauffez-vous dans un vrai sauna à fumée.' },
    ],
  ...
  it: {
    ...
    highlights: [
      ...
      { title: 'Safari in motoslitta', body: 'Laghi ghiacciati e sentieri di fjäll, dal leggero alla gita di un giorno.' },
  ...
  nl: {
    ...
    highlights: [
      ...
      { title: 'Sneeuwscootersafari\'s', body: 'Bevroren meren en fjäll-paden, van rustig tot dagtocht.' },
