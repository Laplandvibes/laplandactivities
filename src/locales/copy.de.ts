...
const de: SectionCopy = {
  ...
  hero: {
    ...
    huskyReindeer: "Husky und Rentier",
    huskyReindeerDesc: "Schlittenfahrten und Farmbesuche",
    snowmobileTours: "Schneemobil-Safaris",
    snowmobileToursDesc: "Geführte Safaris",
    summerAdventures: "Sommerabenteuer",
    summerAdventuresDesc: "Wanderungen, Flüsse, Mitternachtssonne",
  ...
  categoryPage: {
    ...
    activitiesCount: (n, name) => `${name}: ${n} Aktivitäten`,
    comingSoon: 'Aktivitäten für diese Kategorie folgen bald.',
    gygTitlePrefix: 'Die meistgebuchten Touren:',
  ...
  about: {
    ...
    howItems: [
      ...
      "Wir prüfen Saison, Dauer und Leistungen auf der Seite des Veranstalters oder bei GetYourGuide, bevor wir sie aufnehmen.",
      "Wir listen nichts, was wir nicht mit eigenen Worten beschreiben können.",
    ...
    notItems: [
      ...
      "Wir können eine Buchung nicht ändern, stornieren oder erstatten. Wenden Sie sich an die Plattform, bei der Sie gebucht haben.",
      "Wir verkaufen Ihre E-Mail-Adresse nicht. Der Newsletter ist unser eigener, und Sie können ihn mit einem Klick abbestellen.",
    ],
    factsH2: "Unternehmensangaben",
    facts: [
      { label: "Herausgeber", value: "LaPeso Oy" },
      { label: "Handelsregisternummer (Y-tunnus)", value: "3309136-7" },
      { label: "Land", value: "Finnland" },
      { label: "E-Mail", value: "info@laplandvibes.com" },
    ],
    contactH2: "Kontakt",
    contactBody: "Veranstalter, Partner und Leser erreichen uns unter derselben Adresse. Wir lesen jede Nachricht und antworten auf Finnisch oder Englisch.",
    termsLead: "Die vollständige Offenlegung der Partnerlinks und unsere redaktionellen Grundsätze finden Sie in unseren",
