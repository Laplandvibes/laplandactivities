...
const en: SectionCopy = {
  ...
  hero: {
    ...
    huskyReindeer: "Husky and reindeer",
    huskyReindeerDesc: "Sled rides and farm visits",
    snowmobileTours: "Snowmobile safaris",
    snowmobileToursDesc: "Guided safaris",
    summerAdventures: "Summer adventures",
    summerAdventuresDesc: "Hikes, rivers, midnight sun",
  ...
  categoryPage: {
    ...
    activitiesCount: (n, name) => `${name}: ${n} activities`,
  ...
  about: {
    ...
    howItems: [
      ...
      "We check the season, the duration and what is included against the operator or GetYourGuide page before we list it.",
      "We do not list anything we cannot describe in our own words.",
    ...
    notItems: [
      ...
      "We cannot change, cancel or refund a booking. Contact the platform you booked with.",
      "We do not sell your email address. The newsletter is ours and you can leave it with one click.",
    ],
    factsH2: "Company details",
    facts: [
      { label: "Publisher", value: "LaPeso Oy" },
      { label: "Business ID", value: "3309136-7" },
      { label: "Country", value: "Finland" },
      { label: "Email", value: "info@laplandvibes.com" },
    ],
    contactH2: "Contact",
    contactBody: "Operators, partners and readers reach us at the same address. We read every message and answer in Finnish or English.",
    termsLead: "The full affiliate disclosure and our editorial standards are in our",
