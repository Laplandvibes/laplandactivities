...
const es: SectionCopy = {
  ...
  nav: {
    ...
    about: 'Acerca de', fishing: 'Guía de pesca',
  ...
  hero: {
    ...
    stayNearbyDesc: 'Trip.com, mejores tarifas',
    ...
    huskyReindeer: "Huskies y renos",
    huskyReindeerDesc: "Paseos en trineo y visitas a granjas",
    snowmobileTours: "Safaris en moto de nieve",
    snowmobileToursDesc: "Safaris guiados",
    summerAdventures: "Aventuras de verano",
    summerAdventuresDesc: "Senderismo, ríos, sol de medianoche",
  ...
  destPicks: {
    ...
    h2: "Lo que reservaríamos aquí",
    lede: "Seleccionadas a mano y abiertas una a una antes de publicarlas. El precio y la disponibilidad están en la página del socio, por eso no los imprimimos aquí.",
    cta: "Ver disponibilidad",
    disclosure: "Enlaces de afiliado: una reserva nos deja una comisión y a ti te cuesta lo mismo.",
  },
  hotelsStrip: {
  ...
  bookingCta: {
    ...
    blurb: 'En tres toques tiene su viaje a Laponia listo: operadores seleccionados a mano vía GetYourGuide, las mejores tarifas de alojamiento en Trip.com y un coche esperando en el aeropuerto.',
  ...
  categoriesIndex: {
    ...
    lead: 'Nueve formas de vivir el Ártico: elija un hilo y le derivamos a los operadores seleccionados.',
    activitiesLabel: 'actividades',
  ...
  categoryPage: {
    ...
    activitiesCount: (n, name) => `${name}: ${n} actividades`,
  ...
  destinationPage: {
    ...
    sleepInBlurb: 'Iglús de cristal, cabañas, hoteles ski-in: Trip.com agrupa las mejores tarifas.',
    compareHotels: 'Comparar hoteles',
    ...
    tipsByDestination: {
      ...
      yllas: [
        ...
        { tip: 'La red de 300 km de esquí de fondo es de las mejores de Finlandia; mediados de marzo es ideal.', icon: '🎿' },
      ],
      saariselka: [
      ...
      'pyha-luosto': [
        { tip: 'El tren de nieve a la mina de amatista circula en invierno; en verano se sube a pie al Lampivaara.', icon: '💎' },
        { tip: 'Las escaleras de Isokuru abren solo sin nieve; en invierno se rodea por Uhriharju.', icon: '🥾' },
        { tip: 'Luosto es el pueblo tranquilo; Pyhä tiene pistas más grandes y más restaurantes.', icon: '🏔️' },
      ],
      kemijarvi: [
        { tip: 'Una salida diaria del Santa Claus Express continúa de Rovaniemi hasta Kemijärvi.', icon: '🚂' },
        { tip: 'Las grandes esculturas de madera de la semana anual de talla decoran la ciudad todo el año.', icon: '🪵' },
        { tip: 'Pyhä está a 50 km: puede hacer una excursión de un día a los fjells desde una base junto al lago.', icon: '⛷️' },
      ],
    },
  },
  about: {
    ...
    howItems: [
      ...
      "Comprobamos la temporada, la duración y lo que incluye en la página del operador o de GetYourGuide antes de publicarla.",
      "No publicamos nada que no podamos describir con nuestras propias palabras.",
    ...
    notItems: [
      ...
      "No podemos modificar, cancelar ni reembolsar una reserva. Contacte con la plataforma donde reservó.",
      "No vendemos su dirección de correo. El boletín es nuestro y puede darse de baja con un clic.",
    ],
    factsH2: "Datos de la empresa",
    facts: [
      { label: "Editor", value: "LaPeso Oy" },
      { label: "Número de empresa (Y-tunnus)", value: "3309136-7" },
      { label: "País", value: "Finlandia" },
      { label: "Correo", value: "info@laplandvibes.com" },
    ],
    contactH2: "Contacto",
    contactBody: "Operadores, socios y lectores nos encuentran en la misma dirección. Leemos todos los mensajes y respondemos en finés o en inglés.",
    termsLead: "La información completa sobre enlaces de afiliación y nuestros criterios editoriales están en las",
  ...
  bearKuusamo: {
    ...
    ways: {
      title: "Dos maneras de ir",
      eveningLabel: "Tour de tarde (unas 4 horas, de 18 a 22 h)",
    ...
    imageAlts: {
      hero: "Una osa parda salvaje con dos crías al borde del bosque cerca de Kuusamo. Foto: Piritta Paija / Bear Kuusamo",
      tree: "Un joven oso pardo salvaje trepando a un pino cerca de los escondites de Bear Kuusamo. Foto: Piritta Paija / Bear Kuusamo",
    },
    logoAlt: "Bear Kuusamo",
    photoCredit: "Fotos: Piritta Paija / Bear Kuusamo",
    card: {
      eyebrow: "Colaboración comercial",
      title: "Observación de osos salvajes con Bear Kuusamo",
      blurb: "Los escondites de osos más antiguos de la región de Ruka–Kuusamo, al borde de Laponia. Tours de tarde y de noche, del 1 de mayo al 30 de septiembre.",
      cta: "Leer la guía",
    },
  },
  privacy: {
