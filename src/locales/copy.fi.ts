...
const fi: SectionCopy = {
  fishing: {
    ...
    hero: {
      eyebrow: "Suomen Lappi ja Jäämeren rannikko",
      title: 'Kalastus Lapissa ja Jäämerellä',
      sub: "Pilkkiminen on ilmaista eikä vaadi lupaa, lohijoille lupa tarvitaan, ja kuningasrapu haetaan Norjan puolelta. Kokosimme yhteen kauden 2026 avoimet vedet, maksut ja säännöt, jotka pitävät kalakannat elossa.",
      ctaBook: 'Varaa opastettu pilkkiretki',
      ctaRules: 'Luvat ja säännöt →',
      trustLine: "Tiedot on tarkistettu eräluvat.fi:n, maa- ja metsätalousministeriön ja Norjan fiskeridir.no:n sivuilta. Säännöt muuttuvat joka vuosi, joten tarkista oman kalastusalueesi ehdot ennen lähtöä.",
    },
    eyebrows: {
      eco: 'Luonto edellä',
  ...
  hero: {
    ...
    huskyReindeer: "Husky- ja porosafarit",
    huskyReindeerDesc: "Ajelut ja tilavierailut",
    snowmobileTours: "Moottorikelkkasafarit",
    snowmobileToursDesc: "Opastetut safarit",
    summerAdventures: "Kesäretket",
    summerAdventuresDesc: "Vaellukset, joet, keskiyön aurinko",
  ...
  categoryPage: {
    ...
    activitiesCount: (n, name) => `${name}: ${n} aktiviteettia`,
  ...
  about: {
    metaTitle: "Tietoa meistä: keitä olemme ja miten retket valitaan",
    metaDescription: "LaplandActivitiesin julkaisee LaPeso Oy. Listaamme Lapin retkiä, jotka varaisimme itsekin, linkitämme järjestäjälle tai GetYourGuideen ja saamme provision.",
    eyebrow: "Tietoa sivustosta",
    ...
    howItems: [
      ...
      "Tarkistamme kauden, keston ja sisällön järjestäjän tai GetYourGuiden sivulta ennen listausta.",
      "Emme listaa mitään, mitä emme osaa kuvata omin sanoin.",
    ...
    notItems: [
      ...
      "Emme voi muuttaa, perua tai hyvittää varausta. Ota yhteys siihen alustaan, jolta varasit.",
      "Emme myy sähköpostiosoitettasi. Uutiskirje on omamme, ja siitä pääsee pois yhdellä klikkauksella.",
    ],
    factsH2: "Yritystiedot",
    facts: [
      { label: "Julkaisija", value: "LaPeso Oy" },
      { label: "Y-tunnus", value: "3309136-7" },
      { label: "Kotimaa", value: "Suomi" },
      { label: "Sähköposti", value: "info@laplandvibes.com" },
    ],
    contactH2: "Ota yhteyttä",
    contactBody: "Järjestäjät, kumppanit ja lukijat tavoittavat meidät samasta osoitteesta. Luemme jokaisen viestin ja vastaamme suomeksi tai englanniksi.",
    termsLead: "Täysi kumppanilinkkiseloste ja toimitukselliset periaatteet löytyvät",
    termsLink: "käyttöehdoista",
    termsAfter: ".",
    backHome: "Takaisin etusivulle",
  },
  bearKuusamo: {
    metaTitle: "Bear Kuusamo: eettistä karhunkatselua Lapin rajalla",
