...
const it: SectionCopy = {
  ...
  hero: {
    ...
    huskyReindeer: "Husky e renne",
    huskyReindeerDesc: "Giri in slitta e visite alle fattorie",
    snowmobileTours: "Safari in motoslitta",
    snowmobileToursDesc: "Safari guidati",
    summerAdventures: "Avventure estive",
    summerAdventuresDesc: "Escursioni, fiumi, sole di mezzanotte",
  ...
  relatedSites: {
    ...
    links: [
      ...
      { pre: 'In cerca di neve fresca? Scopra', anchor: 'dove sciare in Lapponia', post: 'con confronti località per località.' },
      { pre: 'Per il lato tranquillo dell\'Artico, legga', anchor: 'aurora boreale e parchi nazionali', post: 'e i cieli migliori per l\'aurora.' },
      { pre: 'E prima di prenotare i tour, decida', anchor: 'dove alloggiare in Lapponia', post: ': igloo, baite e resort di montagna.' },
    ],
  },
  faq: {
    kicker: 'Da sapere',
  ...
  about: {
    ...
    howItems: [
      ...
      "Prima di pubblicarla verifichiamo stagione, durata e cosa è incluso sulla pagina dell'operatore o di GetYourGuide.",
      "Non pubblichiamo nulla che non sappiamo descrivere con parole nostre.",
    ...
    notItems: [
      ...
      "Non possiamo modificare, annullare o rimborsare una prenotazione. Contatti la piattaforma su cui ha prenotato.",
      "Non vendiamo il Suo indirizzo e-mail. La newsletter è nostra e può lasciarla con un clic.",
    ],
    factsH2: "Dati societari",
    facts: [
      { label: "Editore", value: "LaPeso Oy" },
      { label: "Numero d'impresa (Y-tunnus)", value: "3309136-7" },
      { label: "Paese", value: "Finlandia" },
      { label: "E-mail", value: "info@laplandvibes.com" },
    ],
    contactH2: "Contatti",
    contactBody: "Operatori, partner e lettori ci trovano allo stesso indirizzo. Leggiamo ogni messaggio e rispondiamo in finlandese o in inglese.",
    termsLead: "L'informativa completa sui link di affiliazione e i nostri criteri editoriali sono nei",
