...
const ptBR: SectionCopy = {
  ...
  hero: {
    ...
    huskyReindeer: "Huskies e renas",
    huskyReindeerDesc: "Passeios de trenó e visitas a fazendas",
    snowmobileTours: "Safáris de moto de neve",
    snowmobileToursDesc: "Safáris guiados",
    summerAdventures: "Aventuras de verão",
    summerAdventuresDesc: "Trilhas, rios, sol da meia-noite",
  ...
  categoryPage: {
    ...
    activitiesCount: (n, name) => `${name}: ${n} atividades`,
  ...
  destinationPage: {
    ...
    tipsByDestination: {
      rovaniemi: [
        ...
        { tip: 'Cruzar a linha do Círculo Polar é grátis, mas o certificado é uma lembrança paga, vendida no posto de informações turísticas do Círculo Polar.', icon: '📜' },
  ...
  about: {
    ...
    howItems: [
      ...
      "Conferimos temporada, duração e o que está incluído na página da operadora ou do GetYourGuide antes de listar.",
      "Não listamos nada que não consigamos descrever com nossas próprias palavras.",
    ...
    notItems: [
      ...
      "Não podemos alterar, cancelar ou reembolsar uma reserva. Fale com a plataforma em que você reservou.",
      "Não vendemos seu e-mail. A newsletter é nossa e você sai dela com um clique.",
    ],
    factsH2: "Dados da empresa",
    facts: [
      { label: "Editora", value: "LaPeso Oy" },
      { label: "Número da empresa (Y-tunnus)", value: "3309136-7" },
      { label: "País", value: "Finlândia" },
      { label: "E-mail", value: "info@laplandvibes.com" },
    ],
    contactH2: "Contato",
    contactBody: "Operadoras, parceiros e leitores nos encontram no mesmo endereço. Lemos todas as mensagens e respondemos em finlandês ou inglês.",
    termsLead: "A divulgação completa dos links de afiliados e nossos critérios editoriais estão nos",
    termsLink: "termos de uso",
    termsAfter: ".",
    backHome: "Voltar ao início",
  },
  bearKuusamo: {
    metaTitle: "Bear Kuusamo: observação ética de ursos | LaplandActivities",
    metaDescription: "A Bear Kuusamo leva você a esconderijos para ver ursos-pardos selvagens a leste de Kuusamo, na borda da Lapônia. De 1º de maio a 30 de setembro.",
  ...
  privacy: {
    ...
    metaDescription: "Como a LaPeso Oy (LaplandActivities) trata seus dados: newsletter, análise de uso e cookies de afiliação. Conforme GDPR e ePrivacy.",
  },
  terms: {
    metaTitle: 'Termos de uso · LaplandActivities',
    metaDescription: "Termos de uso do laplandactivities.fi: conteúdo, licenças, afiliação, responsabilidade e padrões editoriais. Operado pela LaPeso Oy, Finlândia.",
  },
  cookie: {
