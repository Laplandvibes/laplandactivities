// Auto-generated resolved locale data for 'pt-BR' (from the old data.ts maps).
...
const d: LangData = {
  "categories": {
    "adventure": {
      "name": "Aventura",
      "description": "Safáris de snowmobile, kart no gelo, escalada no gelo, rafting em rios e cursos de sobrevivência. Para subir a adrenalina na natureza ártica."
    },
    "animals": {
      "name": "Experiências com animais",
      "description": "Trenó puxado por huskies, visitas a fazendas de renas, observação de ursos selvagens e ursos polares no zoológico de Ranua. Para conhecer os incríveis animais do Ártico."
    },
    "northern-lights": {
      "name": "Aurora boreal",
      "description": "Caça guiada à aurora, tours fotográficos, perseguições de snowmobile e caminhadas com raquetes de neve sob as luzes dançantes."
    },
    "winter-sports": {
      "name": "Esportes de inverno",
      "description": "Esqui alpino, esqui cross-country, snowboard, fat bike, caminhadas com raquetes de neve e patinação nos melhores resorts da Lapônia."
    },
    "wellness": {
      "name": "Bem-estar e sauna",
      "description": "Saunas de fumaça tradicionais, mergulho no gelo, flutuação ártica, tratamentos de spa e a melhor experiência de bem-estar nórdica."
    },
    "culture": {
    ...
    "summer": {
      ...
      "description": "Caminhadas sob o sol da meia-noite, caiaque, rafting, mountain bike, pesca, coleta de frutas silvestres e golfe sob a luz ártica sem fim."
    },
    "food": {
  ...
  "destinations": {
    ...
    "yllas": {
      "name": "Ylläs",
      "tagline": "Duas vilas, uma montanha, um parque nacional",
  ...
  "activities": {
    "rov-aurora-snowmobile": {
      "title": "Safári de snowmobile sob a aurora boreal",
      "description": "Persiga a aurora boreal em um emocionante passeio de snowmobile pela natureza ártica. Pausa com bebidas quentes ao lado da fogueira sob a aurora.",
      "highlights": [
        "Observação da aurora",
        "Pausa na fogueira",
        "Roupa quente fornecida"
      ],
      "duration": "3 h",
      "difficulty": "Moderado",
    ...
    "rov-santa-village": {
      "title": "Experiência na Vila do Papai Noel",
      "description": "Visite a casa oficial do Papai Noel bem em cima do Círculo Polar Ártico. Conheça o Papai Noel, envie cartões-postais do Correio Ártico e cruze a memorável linha do Círculo Polar.",
      "highlights": [
        "Encontro com o Papai Noel",
        "Travessia do Círculo Polar",
    ...
    "rov-husky-safari": {
      "title": "Safári de husky e visita ao canil",
      "description": "Conduza sua própria matilha de huskies pelas florestas nevadas por até 18 km, depois visite o canil para conhecer os filhotes e aprender sobre o mushing ártico.",
      "highlights": [
        "Conduza seu trenó",
        "Visita aos filhotes",
        "Chocolate quente e lanche"
      ],
      "duration": "4 h",
      "difficulty": "Fácil",
    ...
    "rov-reindeer-farm": {
      "title": "Fazenda de renas e passeio de trenó",
      "description": "Visite uma fazenda de renas tradicional, aproveite um tranquilo passeio de trenó pela paisagem de inverno e aprenda sobre a cultura local de criação de renas.",
      "highlights": [
        "Conversa sobre a cultura de criação",
        "Trenó de 2 km",
    ...
    "rov-snowmobile-full": {
      "title": "Expedição de snowmobile na natureza selvagem (dia inteiro)",
      "description": "Uma jornada de snowmobile de dia inteiro no coração da natureza lapônia. Atravesse rios congelados, percorra trilhas florestais e pare em uma cabana para o almoço.",
      "highlights": [
        "Expedição de dia inteiro",
        "Almoço na cabana",
        "Travessias de rios"
      ],
      "duration": "6 h",
    ...
    "rov-ice-karting": {
      "title": "Combo de snowmobile e kart no gelo para famílias",
      "description": "Comece com mini-snowmobiles para crianças, depois corra na pista de gelo em kart. Aqueça-se em seguida com chocolate quente.",
      "highlights": [
        "Snowmobiles para crianças",
        "Pista de kart no gelo",
        "Ideal para famílias"
      ],
      "duration": "3 h",
      "difficulty": "Fácil",
    ...
    "rov-arktikum": {
      "title": "Museu de ciências Arktikum e centro ártico",
      "description": "Explore a fascinante história e cultura da região ártica neste museu de alto nível com uma arquitetura impressionante de túnel de vidro com vista para o rio Ounasjoki.",
      "highlights": [
        "Exposições interativas",
        "Teatro da aurora boreal",
        "História ártica"
      ],
      "duration": "2-3 h",
      "difficulty": "Fácil",
    ...
    "rov-husky-summer": {
      "title": "Visita de verão a um canil de huskies",
      "description": "Veja o que os cães de trenó fazem nas férias: conheça um canil em atividade no verão, encontre os filhotes do ano e aprenda como os huskies treinam e descansam entre as temporadas. Uma visita tranquila e familiar, cujo ponto alto é o cercado dos filhotes.",
      "highlights": [
        "Conheça os filhotes do ano",
        "Tour pelo canil em atividade",
        "Para toda a família"
      ],
      "duration": "2 h",
      "difficulty": "Fácil",
    ...
    "rov-ranua-zoo": {
      "title": "Parque de vida selvagem de Ranua, ursos polares",
      "description": "Conheça os animais árticos, incluindo os únicos ursos polares da Finlândia. Caminhe por trilhas nevadas entre carcajus, linces, lobos e cerca de 50 espécies árticas.",
      "highlights": [
        "Ursos polares",
        "Mais de 50 espécies árticas",
        "Trilhas"
      ],
      "duration": "3-4 h",
      "difficulty": "Fácil",
    ...
    "rov-ice-floating": {
      "title": "Experiência de flutuação no gelo ártico",
      "description": "Flutue em um rio congelado vestindo uma roupa estanque sob o céu ártico. Uma experiência surreal e tranquila, seguida de bebidas quentes ao lado de um fogo aberto.",
      "highlights": [
        "Roupa estanque fornecida",
        "Bebidas quentes incluídas",
        "Experiência única"
      ],
      "duration": "3 h",
      "difficulty": "Fácil",
      "category": "Bem-estar e sauna"
    },
    "rov-santapark": {
      "title": "Caverna subterrânea SantaPark",
      "description": "Um parque temático de Natal subterrâneo dentro de uma caverna de verdade. Escola de elfos, galeria de gelo, confeitaria de pão de mel e espetáculos memoráveis no subsolo ártico.",
      "highlights": [
        "Caverna subterrânea",
        "Escola de elfos",
        "Galeria de gelo"
    ...
    "rov-arctic-snow-hotel": {
      "title": "Pernoite no Arctic Snow Hotel",
      "description": "Durma em um quarto inteiramente feito de gelo e neve a -5 °C dentro de um saco de dormir térmico. Sauna, jantar e despertar com aurora boreal incluídos.",
      "highlights": [
        "Pernoite em quarto de gelo",
        "Despertar com aurora boreal",
        "Sauna e jantar incluídos"
      ],
      "duration": "Pernoite",
      "difficulty": "Moderado",
      "category": "Aventura"
    ...
    "rov-ounasvaara-ski": {
      "title": "Esqui e snowboard em Ounasvaara",
      "description": "Esquie nas pistas urbanas de Rovaniemi. 10 pistas e trilhas de cross-country no centro, perfeitas para uma sessão rápida entre as outras atividades.",
      "highlights": [
        "Na cidade",
        "Esqui noturno",
        "Aluguel disponível"
    ...
    "rov-campfire-dinner": {
      "title": "Jantar na fogueira em meio à natureza selvagem",
      "description": "Aproveite um jantar lapônio tradicional preparado em fogo aberto na natureza. Salmão grelhado, salsicha de rena e sobremesa de frutas vermelhas sob o céu ártico.",
      "highlights": [
        "Cozimento em fogo aberto",
        "Cardápio lapônio",
        "Ambiente selvagem"
      ],
      "duration": "3 h",
    ...
    "lev-ice-karting": {
      "title": "Kart no gelo em lago congelado",
      "description": "Corra em karts de alto desempenho em uma pista de gelo profissionalmente preparada sobre um lago congelado. Derrape nas curvas a toda velocidade em uma experiência ártica impressionante.",
      "highlights": [
        "Pista em lago congelado",
    ...
    "lev-snowvillage": {
      "title": "Hotel de gelo SnowVillage, a 30 min de Levi",
      "description": "Percorra uma vila inteira feita de gelo e neve, a 30 minutos de Levi, em Lainio, com quartos finamente esculpidos, um bar de gelo e uma capela. Novo tema a cada ano.",
      "highlights": [
        "Esculturas de gelo",
        "Bar de gelo",
        "Novo tema a cada ano"
      ],
      "duration": "1 h",
      "difficulty": "Fácil",
      "category": "Cultura e patrimônio"
    ...
    "lev-husky-safari": {
      "title": "Safári de husky de Levi",
      "description": "Conduza sua própria matilha de huskies pela natureza silenciosa ao redor de Levi. Percurso de 15 km entre florestas congeladas com pausa para café na fogueira.",
      "highlights": [
        "Conduza seu trenó",
        "Percurso de 15 km",
        "Pausa na fogueira"
    ...
    "lev-snowmobile": {
      "title": "Safári de snowmobile até a fazenda de renas",
      "description": "Cavalgue de snowmobile pela floresta até uma fazenda de renas tradicional. Dois clássicos da Lapônia em um único passeio empolgante.",
      "highlights": [
        "Passeio de snowmobile",
        "Visita à fazenda de renas",
        "Bebidas quentes"
      ],
      "duration": "3 h",
      "difficulty": "Moderado",
    ...
    "lev-aurora-photo": {
      "title": "Tour fotográfico da aurora boreal",
      "description": "Um tour da aurora focado em fotografia conduzido por um guia profissional. Aprenda a capturar as luzes com a câmera enquanto saboreia um suco quente de frutas vermelhas.",
      "highlights": [
        "Dicas de fotografia e tripés",
        "Melhores pontos de aurora",
        "Bebidas quentes e lanche"
      ],
      "duration": "4 h",
      "difficulty": "Fácil",
      "category": "Aurora boreal"
    ...
    "lev-midnight-sun-golf": {
      "title": "Golfe ao sol da meia-noite",
      "description": "Jogue golfe sob o sol da meia-noite em um dos campos mais ao norte do mundo. Tee à meia-noite em plena luz do dia durante o verão ártico.",
      "highlights": [
        "Tee à meia-noite",
        "Campo de 18 buracos",
        "Paisagem ártica"
    ...
    "lev-ice-fishing": {
      "title": "Pesca no gelo em lago congelado",
      "description": "Perfure o gelo de um lago congelado e pesque perca e coregono com as técnicas tradicionais lapônias. A pesca é preparada em fogo aberto.",
      "highlights": [
        "Pesca e cozimento",
    ...
    "lev-fatbike": {
      "title": "Tour de fat bike na floresta nevada",
      "description": "Pedale de fat bike por trilhas nevadas e paisagens congeladas. Os pneus largos aderem à neve enquanto você atravessa antigas florestas boreais.",
      "highlights": [
        "Fat bike fornecida",
        "Trilhas florestais",
        "Bebidas quentes depois"
      ],
      "duration": "2 h 30",
      "difficulty": "Moderado",
      "category": "Esportes de inverno"
    ...
    "lev-bike-park": {
      ...
      "description": "Desça em descidas no Levi Bike Park com trilhas servidas por teleféricos, das flow trails para iniciantes às descidas pretas para experts.",
      "highlights": [
        "Servido por teleférico",
        "Todos os níveis",
        "Aluguel disponível"
      ],
      "duration": "Diário",
    ...
    "yll-aurora-hunt": {
      "title": "Caça à aurora a partir do monte Ylläs",
      "description": "Ylläs tem um dos céus noturnos mais escuros e limpos da Finlândia. Persiga a aurora com guias experientes que conhecem os melhores pontos de observação no monte e ao seu redor.",
      "highlights": [
        "Zona Dark Sky",
        "Guias experientes",
        "Vista do monte"
    ...
    "yll-snowmobile": {
      "title": "Safári de snowmobile na natureza selvagem",
      "description": "Cavalgue pela natureza intocada entre os montes Ylläs e Pallas. As trilhas atravessam pântanos congelados, florestas boreais e paisagens abertas de montanha.",
      "highlights": [
        "Percurso selvagem",
        "Paisagens de montanha",
        "Roupa quente incluída"
      ],
      "duration": "3 h",
      "difficulty": "Moderado",
      "category": "Aventura"
    ...
    "yll-pallas-hike": {
      "title": "Caminhada no Parque Nacional Pallas-Yllästunturi",
      "description": "Caminhe pelo parque nacional mais visitado da Finlândia por trilhas de montanha sinalizadas a partir de Ylläs. Vistas notáveis de monte a monte, florestas antigas e riachos cristalinos.",
      "highlights": [
    ...
    "yll-husky": {
      "title": "Safári de husky de dia inteiro no Parque Nacional Pallas-Yllästunturi",
      "description": "Conduza sua própria matilha de huskies pelo Parque Nacional Pallas-Yllästunturi com uma pequena fazenda familiar de Rauhala, ao norte de Ylläs. Máximo de seis participantes por passeio.",
      "highlights": [
        "Grupo pequeno",
        "Trilhas do parque nacional",
        "Encontro com os huskies"
      ],
      "duration": "5-6 h",
      "difficulty": "Moderado",
      "category": "Experiências com animais"
    ...
    "yll-snowshoe": {
      "title": "Caminhada com raquetes de neve na floresta antiga",
      "description": "Caminhe sobre a neve fofa intocada em florestas antigas. O guia compartilha as histórias da floresta enquanto você aproveita o silêncio total da natureza ártica.",
      "highlights": [
        "Raquetes de neve fornecidas",
        "Floresta antiga",
        "Silêncio sereno"
      ],
      "duration": "3 h",
    ...
    "yll-lainio-snow": {
      ...
      "description": "Explore o hotel de gelo, o restaurante de gelo e a capela de gelo em Lainio. Reconstruído a cada ano com um novo tema, uma surpreendente arquitetura de gelo para percorrer.",
      "highlights": [
        "Hotel de gelo",
        "Restaurante de gelo",
        "Novo tema a cada ano"
    ...
    "yll-reindeer": {
      "title": "Passeio de trenó de renas em Ylläs",
      "description": "Deslize pelas paisagens nevadas em um trenó tradicional puxado por renas. O ritmo lento permite que você absorva o silêncio ártico e aprecie a beleza congelada.",
      "highlights": [
        "Trenó tradicional",
        "Paisagem de inverno",
        "Bebidas quentes"
    ...
    "saa-gold-panning": {
      "title": "Garimpo de ouro em Tankavaara",
      "description": "Procure ouro de verdade no museu do ouro da Finlândia. Aprenda as técnicas da corrida do ouro lapônia de 1868 e fique com o ouro que encontrar.",
      "highlights": [
        "Fique com seu ouro",
        "Museu incluído",
        "Garimpo ativo"
    ...
    "saa-amethyst-mine": {
      "title": "Visita à mina de ametista",
      "description": "Escave sua própria ametista na única mina ativa da Europa, no topo do monte Lampivaara. No inverno, suba a montanha no trenó aquecido Amethyst Pendolino; no verão, é uma curta caminhada panorâmica a partir do café.",
      "highlights": [
        "Escave sua gema",
        "Fique com uma ametista",
        "Localização no monte"
      ],
      "duration": "3 h",
      "difficulty": "Fácil",
      "category": "Cultura e patrimônio"
    ...
    "saa-uk-national-park": {
      "title": "Trekking no Parque Nacional Urho Kekkonen",
      "description": "Explore uma das maiores áreas selvagens da Europa. Caminhadas de um dia a partir de Kiilopää, ou treks de vários dias por paisagens intocadas de montanha, com cabanas ao longo do caminho.",
      "highlights": [
        "Entrada gratuita",
        "Cabanas selvagens",
        "Área de 2.550 km²"
      ],
      "duration": "1 d - vários dias",
      "difficulty": "Moderado",
      "category": "Aventuras de verão"
    },
    "saa-kiilopaa-sauna": {
      "title": "Sauna de fumaça Kiilopää e mergulho no gelo",
      "description": "Experimente a mais famosa sauna de fumaça da Finlândia no centro de montanha de Kiilopää. Aqueça-se na savusauna tradicional, depois mergulhe no gélido riacho de montanha Kiilopuro.",
      "highlights": [
        "Famosa sauna de fumaça",
        "Mergulho no gelo",
        "Aberto o ano todo"
      ],
      "duration": "2-3 h",
    ...
    "saa-snowmobile": {
      "title": "Safári de snowmobile na natureza de Saariselkä",
      "description": "Cavalgue pelos montes selvagens que fazem fronteira com o Parque Nacional Urho Kekkonen. A paisagem aqui é mais áspera e remota do que em qualquer outra parte da Lapônia finlandesa.",
      "highlights": [
        "Fronteira selvagem",
        "Paisagens de montanha",
        "Roupa quente incluída"
    ...
    "saa-aurora-hunt": {
      "title": "Tour da aurora de ônibus a partir de Saariselkä",
      "description": "Persiga a aurora de ônibus até os pontos mais escuros da região de Saariselkä. Sem poluição luminosa, garantindo algumas das observações mais nítidas de toda a Finlândia.",
      "highlights": [
        "Poluição luminosa mínima",
        "Bebidas quentes",
        "Vários pontos de observação"
      ],
      "duration": "3 h",
      "difficulty": "Fácil",
      "category": "Aurora boreal"
    ...
    "saa-ice-fishing": {
      "title": "Experiência de pesca no gelo ártico",
      "description": "Perfure o gelo espesso de um lago congelado e pesque perca e coregono com métodos tradicionais; depois, aqueça-se com um almoço de fogueira em uma lavvu.",
      "highlights": [
        "Almoço de pesca e cozimento",
    ...
    "ina-lake-cruise": {
      "title": "Cruzeiro de barco no lago Inari",
      "description": "Navegue pelo terceiro maior lago da Finlândia, com mais de 3.000 ilhas. Navegue junto à sagrada ilha de Ukonsaari e aproveite panoramas árticos notáveis.",
      "highlights": [
        "3.000 ilhas",
        "Vistas de Ukonsaari",
        "Panoramas árticos"
    ...
    "ina-midnight-kayak": {
      "title": "Caiaque ao sol da meia-noite no lago Inari",
      "description": "Reme no lago Inari sob o sol da meia-noite, explorando ilhas e margens. A luz dourada refletida na água calma cria uma atmosfera única.",
      "highlights": [
        "Sol da meia-noite",
        "Exploração de ilhas",
        "Observação da fauna"
    ...
    "ina-pielpajärvi": {
      "title": "Trekking até a igreja selvagem de Pielpajärvi",
      "description": "Caminhe (ou esquie no inverno) até uma das igrejas mais remotas da Finlândia, construída em 1760 em meio à natureza. Uma bela trilha de 4,5 km por florestas seculares.",
      "highlights": [
        "Igreja histórica",
        "Trilha de 4,5 km",
        "Ambiente selvagem"
    ...
    "ina-aurora": {
      "title": "Caça à aurora boreal a partir de Inari",
      "description": "Inari oferece alguns dos céus mais escuros da Finlândia. O guia usa dados de aurora em tempo real para encontrar os melhores pontos de observação ao redor do lago.",
      "highlights": [
        "Céus mais escuros",
    ...
    "ina-berry-foraging": {
      "title": "Coleta de frutas silvestres e cogumelos",
      "description": "Colha amoras-árticas, oxicocos e cogumelos na floresta ártica com um guia local. Aprenda os métodos tradicionais de conservação e preparo.",
      "highlights": [
        "Amoras-árticas",
        "Guia experiente",
    ...
    "ruk-karhunkierros": {
      "title": "Trekking na trilha do urso Karhunkierros",
      "description": "A trilha de caminhada mais famosa da Finlândia, 82 km pelo Parque Nacional de Oulanka. Pontes suspensas, corredeiras, cachoeiras e floresta boreal intocada.",
      "highlights": [
        "Trilha de 82 km",
        "Pontes suspensas",
    ...
    "ruk-bear-watching": {
      "title": "Observação de ursos selvagens a partir de esconderijo",
      "description": "Passe uma noite em um esconderijo fotográfico perto da fronteira russa para observar os ursos-pardos selvagens em seu habitat natural. Taxa de avistamento de 95%.",
      "highlights": [
        "95% de sucesso",
        "Esconderijo fotográfico",
        "Ursos selvagens"
      ],
      "duration": "Pernoite",
      "difficulty": "Moderado",
    ...
    "ruk-river-rafting": {
      "title": "Rafting em águas brancas no rio Kitka",
      "description": "Enfrente corredeiras de classe II-III no rio Kitka de águas cristalinas pelo Parque Nacional de Oulanka. Perfeita combinação de adrenalina e natureza notável.",
      "highlights": [
        "Corredeiras classe II-III",
        "Paisagens de Oulanka",
        "Todo o equipamento fornecido"
      ],
      "duration": "3 h",
      "difficulty": "Moderado",
      "category": "Aventura"
    ...
    "ruk-husky": {
      "title": "Safári de husky de Ruka",
      "description": "Conduza sua matilha de huskies do Alasca pela floresta de Ruka. Visite o canil e conheça os cães antes do passeio.",
      "highlights": [
        "Conduza seu trenó",
        "Visita ao canil",
        "Trilhas florestais"
    ...
    "ruk-ice-climbing": {
      "title": "Escalada no gelo no cânion de Korouoma",
      "description": "Escale as cachoeiras congeladas no notável cânion de Korouoma. Os guias profissionais fornecem todo o equipamento e instrução para iniciantes e avançados.",
      "highlights": [
    ...
    "ruk-aurora": {
      "title": "Caminhada com raquetes de neve sob a aurora boreal",
      "description": "Caminhe com raquetes de neve pela floresta silenciosa até um ponto panorâmico na colina, depois aguarde a aurora com bebidas quentes e uma fogueira.",
      "highlights": [
        "Caminhada com raquetes de neve",
        "Ponto panorâmico na colina",
        "Fogueira e bebidas"
      ],
      "duration": "3 h",
      "difficulty": "Fácil",
    ...
    "pos-riisitunturi": {
      "title": "Parque Nacional Riisitunturi, árvores de neve",
      "description": "Famoso pelas espetaculares árvores \"tykky\" coroadas de neve que parecem esculturas congeladas. Um dos parques nacionais mais fotogênicos da Finlândia.",
      "highlights": [
        "Árvores tykky",
        "Entrada gratuita",
        "Paisagem icônica"
    ...
    "pos-korouoma": {
      "title": "Cânion de Korouoma e cachoeiras congeladas",
      "description": "Caminhe pelo dramático cânion de Korouoma para ver enormes cachoeiras congeladas de até 40 metros de altura. Escalada no gelo opcional para os aventureiros.",
      "highlights": [
        "Cachoeiras congeladas de 40 m",
        "Caminhada no cânion",
        "Opção de escalada no gelo"
      ],
      "duration": "5 h",
      "difficulty": "Moderado",
      "category": "Aventura"
    ...
    "pos-pentik": {
      "title": "Visita ao centro de cerâmica Pentik",
      "description": "Visite o berço da Pentik, sede da fábrica de cerâmica mais setentrional do mundo. Veja as galerias e o Museu Internacional da Xícara de Café e, depois, passe pela loja outlet.",
      "highlights": [
        "Galeria Anu Pentik",
        "Museu da cerâmica",
        "Loja outlet"
    ...
    "tor-icebreaker": {
      "title": "Cruzeiro no quebra-gelo Sampo",
      "description": "Navegue pelo mar Báltico congelado em um verdadeiro navio quebra-gelo, depois flutue no mar congelado vestindo uma roupa de sobrevivência. Uma experiência ártica imperdível.",
      "highlights": [
        "Verdadeiro quebra-gelo",
        "Flutuação no mar",
        "Lista de desejos"
      ],
      "duration": "4 h",
    ...
    "tor-green-zone": {
      "title": "Green Zone Golf, dois países",
      "description": "Jogue golfe em dois países na fronteira Finlândia-Suécia. Tee na Finlândia, putt na Suécia. Em uma volta, você cruza quatro vezes a fronteira, e com ela uma hora de diferença de fuso.",
      "highlights": [
        "Dois países",
        "Dois fusos horários",
        "Golfe ao sol da meia-noite"
      ],
      "duration": "3-4 h",
      "difficulty": "Fácil",
      "category": "Aventuras de verão"
